      ...
      <h1 class="head_inner">Gallery</h1>
        <div class="large-12 column">
          <div id="galleria">
            ...
            <img src="img/images_gallery/22.png" title="Brinkman Surveying<br><small>Adobe CS6 (Illustrator, Photoshop, Fireworks) Notepad ++, Firebug</small>" alt="Brinkman Surveying wanted a good looking web presence that allows their customers to communicate with them online. The site is streamlined and mobile-friendly.<br><small>brinkmansurveying.com</small>
            "></a>
            <a href="img/images_gallery/b-02.png" id="fullscreen">
            <img src="img/images_gallery/02.png" title="Mock - Nu Skool In School<br><small>Fireworks CS5, Photoshop CS5</small>" alt="One of my tasks at 352 was to create an imaginary charity and design a homepage for it. I came up with a charity that keeps teachers and students engaged with music via electronic components such as analog synthesizers.
            "></a>
            <a href="img/images_gallery/b-21.png" id="fullscreen">
            <img src="img/images_gallery/21.png" title="OwnForce<br><small>Adobe CS6 (Illustrator, Photoshop, Fireworks) Ruby on Rails</small>" alt="I designed the initial logo, mockups and graphics implemented throughout. I also did stationary in Illustrator and Photoshop, examples of which can be found on Behance.<br><small>ownforce.com</small>
            "></a>
            <a href="img/images_gallery/b-20.png" id="fullscreen">
            <img src="img/images_gallery/20.png" title="Same Day Appliance Repair<br><small>Notepad++, Firebug, Fireworks CS6, Photoshop CS6</small>" alt="Same Day Appliance Repair wanted a website that looked friendly and professional, provided tips for appliance maintenance and allowed online inquiries. It's due for an update in 2015.<br><small>samedayrepairgainesville.com<br>samedayrepairjax.com</small>
            "></a>
            <a href="img/images_gallery/b-01.png" id="fullscreen">
            <img src="img/images_gallery/01.png" title="Mock - Space Movie<br><small>Fireworks CS5, Photoshop CS5</small>" alt="The goal of this project from 352 was to mock a website for what inspires me. I thought of space and movies, so I put them together and created a site for a Space Movie. The design was built around an image from the game Starcraft 2.
            "></a>
            <a href="img/images_gallery/b-05.png" id="fullscreen">
            <img src="img/images_gallery/05.png" title="Calvin and Hobbes Themed Responsive Layout<br><small>Dreamweaver CS5, Notepad++, Firebug, Photoshop CS5</small>" alt="I built this layout using tools in Dreamweaver. I used photographs of my Calvin and Hobbes collection for graphics. Currently, I use it as a base for extremely simple responsive layouts despite abandoning Dreamweaver as a tool.<br><small>http://www.dustinaguilar.com/adapt</small>
            " ></a>
            <a href="img/images_gallery/b-09.png" id="fullscreen">
            <img src="img/images_gallery/09.png" title="Helvetica Article<br><small>Photoshop CS5, InDesign CS5</small>" alt="The goal for this early school project was to design a magazine layout based on the font Helvetica. NASA's Space Shuttle is a recognizable American icon, so replacing 'United States' with 'Helvetica' seemed like a good choice for a potent delivery of the article's subject matter.
            "></a>
            <a href="img/images_gallery/b-12.png" id="fullscreen">
            <img src="img/images_gallery/12.png" title="Ultimate Party Bus<br><small>Notepad ++, Firebug, Photoshop CS5</small>" alt="Initial graphic work for Ultimate Party Bus -- Unfortunately, due to time constraints with school and work, we put the task of design in more capable hands while I did IT work and smaller, manageable projects so I could focus on school.
            "></a>
           ...
           <!--  <a href="img/images_gallery/b-07.png" id="fullscreen">
            ...
            <img src="img/images_gallery/14.png" title="Lighting Project<br><small>Photoshop CS5</small>" alt="One night for fun, I decided to work on achieving accurate lighting. Using a Mercedes-Benz photo, I replaced the cars with Sterling Limousines' H2 stretch and their Range Rover.
            "></a>
            <a href="img/images_gallery/b-15.png" id="fullscreen">
            <img src="img/images_gallery/15.png" title="Booyah Supersnacks<br><small>Illustrator CS5</small>" alt="Booyah Supersnacks was a fun Illustrator project I did in school that, for the most part, speaks for itself :)
            "></a>
